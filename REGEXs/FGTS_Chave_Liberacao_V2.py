...
def regex_fgts_chave_v2(contra_cheque, obj_response):
    if re.search(r'CSE - Conectividade Social \/ Empregador',contra_cheque) is not None: 
        obj_response["Nome"]="FGTS_Chave_Liberacao-V2"
