...
def regex_adiantamento(contra_cheque, obj_response):
    if re.search(r'Adiantamento',contra_cheque) is not None and re.search(r'CC:',contra_cheque) is not None and re.search(r'CBO',contra_cheque) is not None and re.search(r'Nome do Funcionário',contra_cheque) is not None: 
        obj_response["Nome"]="Recibo Adiantamento"
        obj_response["Tipo"]="157"
