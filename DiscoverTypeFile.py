...
def find_type_file(pdf_data,arquivo,file_name):
    ...
    from Contra_Cheque import regex_contra_cheque
    from Folha_Pagamento import regex_folha_pagamento
    from FGTS import regex_fgts
    from GFIP_GPS import regex_gps
    from DAE import regex_dae
    from RE import regex_re
    from GFIP_Rubrica import regex_gfip_rubrica
    from GFIP_Compensacao import regex_compensacao
    from GFIP_Protocolo_caixa import regex_envio_arquivos
    from GRRF_Relatorio import regex_grrf_relatorio
    from IRPF_Recibo import regex_Irpf
    from Renuncia_Vale import regex_renuncia_vale
    from DEFIS import regex_defis
    from DMA_RESUMO import regex_dma_resumo
    from DMD_MOV import regex_dmd_mov
    from ReciboPDF_EFD_CONTRIBUICOES import regex_efd_contribuicoes
    from GPS_Parcelamento import regex_gps_parcelamento
    from Recibo_Ferias import regex_recibo_ferias
    from Aviso_Empreg_Indenizado import regex_empreg_indenizado
    from Aviso_Empreg_IndenizadoV2 import regex_empreg_indenizadoV2
    from FGTS_Chave_Liberacao import regex_fgts_chave
    from Termo_Rescisao_Frente import regex_termo_rescisao_frente
    from Termo_Rescisao_Verso import regex_termo_rescisao_verso
    from Relacao_Salarios_Contribuicao import regex_relacao_salarios_contribuicao
    from Darf import regex_darf
    from ISS import regex_iss
    from DAS import regex_das
    from AvisoFerias import regex_AvisoFerias
    from Carta_Referencia import regex_CartaReferencia
    from CadNacioanlPessJur import regex_CadNacPessJur
    from CertidaoFederalCond import regex_CertidaoFederalCond
    from ExtratoContaFundoGarantia import regexExtratoContFundoGarantFGTS
    from GRRF_FGTS import regex_grrf_fgts
    from RequerimentoSeguroDesemprego import regex_req_seguro_desemprego
    from ExtratoFGTS import regexExtratoFGTSTrabalhador
